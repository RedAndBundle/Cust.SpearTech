...
Report 80400 "PTE US Check"
{
    ...
    begin
        ...
        if Setup."Global Check No." and (Setup."Global Last Check No." <> '') then
            Args."Check No." := Setup."Global Last Check No."
        else begin
    ...
    begin
        if Setup."Global Check No." then
            Setup."Global Last Check No." := Model."Check No.";
    end;
